    ...
    overview: {
      primaryDescription: (
        <>
          ...
          <Typography as='p' marginBottom='.5rem'>
            This course is right for you if you have a strong STEM background,
            for example a data scientist, computational scientist, or industry
            specialist.
          </Typography>
          <Typography as='p' marginBottom='2.5rem'>
            Guided by IBM Quantum computing experts, you will learn the
            fundamentals of quantum computing. This foundation gives you the
            necessary skills, terminology, and concepts required for success in
      ...
      secondaryDescription: (
        <>
          ...
          <Typography as='p' marginBottom='.5rem'>
            To succeed in this course, you should understand these
            prerequisites. We provide opportunities to increase your knowledge
            about topics before each module.
          </Typography>
          <UnorderedList nested>
            <ListItem>
              Basic linear algebra: Solve systems of equations with matrices,
              eigenvalues and eigenvectors, and linear transformations. We will
              cover tensor products.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              Statistics and probability: Comprehend probability and other
              stochastic notions.
            </ListItem>
            <ListItem>
