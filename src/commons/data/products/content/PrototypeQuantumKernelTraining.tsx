    ...
    overview: {
      primaryDescription: (
        <>
          ...
          A key observation of this work was that a necessary condition for a computational advantage requires quantum circuits for the kernel that are hard to estimate classically. More recently, researchers proved that a quantum kernel can offer superpolynomial speedups over any classical learner on a particular learning problem based on the hardness of the discrete logarithm problem 
          ...
          Furthermore, this particular kernel is contained in a kernel family, called covariant quantum kernels, that can be used for data with a group structure 
      ...
      description: (
        <>
          ...
          <a
            ...
            </a>{' '} provides more information on cloning git repositories using ssh keys.
          </Typography>
          ...
          <Typography as='p' marginBottom='1rem'>
          To avoid dependency conflicts, it is recommended to first start a new Python development environment. We use 
          {' '}   
          <a
          ...
          <Typography as='p' marginBottom='1rem'>
          After the dependencies have installed, users may run the 
          tutorials {' '}
          <a
